...
search_terms = ["Software Engineer", "Software Developer",  "Java Developer", "Back End Developer", "Backend Developer", "Software Development Engineer", "SDE", "SDE1", "SDE2"]
...
location = ["Bengaluru", "Noida", "Hyderabad", "Gurugram"]                      # (dynamic multiple select)
...
in_your_network = True            # True or False, Note: True or False are case-sensitive
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "CNC", "Data Engineer", "Razorpay"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
